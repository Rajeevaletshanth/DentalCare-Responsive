...
const LogoDesign = () => {
  ...
  const themes = [
    {
      path : "../../images/graphics/logos/1.jpg",
      content : "Theme 1",
    },
    {
      path : "../../images/graphics/logos/2.jpg",
      content : "Theme 2",
    },
    {
      path : "../../images/graphics/logos/3.jpg",
      content : "Theme 3",
    },
    {
      path : "../../images/graphics/logos/4.jpg",
      content : "Theme 4",
    },
    {
        path : "../../images/graphics/logos/5.jpg",
        content : "Theme 5",
    }
  ]
  ...
  const getGraphics = async() => {
    await axios.get(`${configData.SERVER_URL}/admin/graphics/get/${admin_id}`).then((res) => {
      if(res.data.length > 0){
        setNewLayout(false);
        setActiveIndex(res.data[0].logo);
  ...
  return (
    ...
    <Toaster />
    <div class="row">
      {/* <h3 class="mt-3 ml-4">{t("Graphics.Logo Designs")}</h3> */}
      <div class="col-12 grid-margin stretch-card">
        <div class="card card-custom">
        

      <div className='ml-4 mt-4 mr-4'>
      <h4 class="card-title">{t("Graphics.Logo Designs")}</h4>

      {/* <h4 class="card-title mt-5 ml-5">Choose theme :</h4> */}
        <div class="row row-cols-1 row-cols-md-4 g-5 ml-4 mt-5 mr-4" >
