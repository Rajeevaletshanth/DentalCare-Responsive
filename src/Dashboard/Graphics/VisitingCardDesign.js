...
const VisitingCardDesign = () => {
  ...
  const themes = [
    {
      path : "../../images/graphics/visiting_cards/1.jpg",
      content : "Theme 1",
    },
    {
      path : "../../images/graphics/visiting_cards/2.jpg",
      content : "Theme 2",
    },
    {
      path : "../../images/graphics/visiting_cards/3.jpg",
      content : "Theme 3",
    },
    {
      path : "../../images/graphics/visiting_cards/4.jpg",
      content : "Theme 4",
    },
    {
      path : "../../images/graphics/visiting_cards/5.jpg",
      content : "Theme 5",
    }
  ]
  ...
  const getGraphics = async() => {
    await axios.get(`${configData.SERVER_URL}/admin/graphics/get/${admin_id}`).then((res) => {
      if(res.data.length > 0){
        setNewLayout(false);
        setActiveIndex(res.data[0].visiting_card);
  ...
  return (
    ...
    <div class="row">
      ...
      <h4 class="card-title">{t("Graphics.Visiting Cards")}</h4>
